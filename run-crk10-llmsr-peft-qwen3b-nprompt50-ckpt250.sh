#!/usr/bin/env bash
# Post-GRPO LLM-SR on crk10: Qwen2.5-3B + LoRA checkpoint-250 (nprompt50).
# See run-crk4-llmsr-peft-qwen3b-nprompt10-ckpt300.sh for notes.
set -euo pipefail
REPO=/home/grads/sanchit23/downloaded_decaevolve-1215
cd "$REPO"
PEFT="${REPO}/grpo_checkpoints/crk10-V2-adaptive-Qwen/Qwen2.5-3B-Instruct-r8-ga4-g64-lr1e-06/nprompt50/checkpoint-250"
LOGDIR="${REPO}/logs/crk10_llmsr_peft_qwen3b_nprompt50_ckpt250"
mkdir -p "$LOGDIR"
