...
#                --log_path "./logs/oscillator1_llmsr_Qwen2.5-0.5B-Instruct" \
#                > ./logs/oscillator1_llmsr_Qwen2.5-0.5B-Instruct/main.txt 2>&1 
#             #    --hf_model "Qwen/Qwen2.5-0.5B-Instruct"
...
#                --hf_model "Qwen/Qwen2.5-0.5B-Instruct" \
#                --log_path "./logs/oscillator2_llmsr_Qwen2.5-0.5B-Instruct" \
#                > ./logs/oscillator2_llmsr_Qwen2.5-0.5B-Instruct/main.txt 2>&1 
#             #    --hf_model "Qwen/Qwen2.5-0.5B-Instruct"
#             #    --log_path "./logs/oscillator1_v16"
#             #    --use_wandb True
...
#                --hf_model "Qwen/Qwen2.5-0.5B-Instruct" \
#                --log_path "./logs/bactgrow_llmsr_Qwen2.5-0.5B-Instruct" \
#                > ./logs/bactgrow_llmsr_Qwen2.5-0.5B-Instruct/main.txt 2>&1 
#             #    --hf_model "Qwen/Qwen2.5-0.5B-Instruct"
#             #    --log_path "./logs/oscillator1_v16"
#             #    --use_wandb True
...
#                --hf_model "Qwen/Qwen2.5-0.5B-Instruct" \
#                --log_path "./logs/stressstrain_llmsr_Qwen2.5-0.5B-Instruct" \
#                > ./logs/stressstrain_llmsr_Qwen2.5-0.5B-Instruct/main.txt 2>&1 
#             #    --hf_model "Qwen/Qwen2.5-0.5B-Instruct"
#             #    --log_path "./logs/oscillator1_v16"
#             #    --use_wandb True
...
#                --use_atomsr True \
#                --hf_model "Qwen/Qwen2.5-0.5B-Instruct" \
#                --log_path "./logs/oscillator1_llmsr_dec_Qwen2.5-0.5B-Instruct" \
#                > ./logs/oscillator1_llmsr_dec_Qwen2.5-0.5B-Instruct/main.txt 2>&1 
#             #    --hf_model "Qwen/Qwen2.5-0.5B-Instruct"
#             #    --log_path "./logs/oscillator1_v16"
#             #    --use_wandb True
...
#                --use_atomsr True \
#                --hf_model "Qwen/Qwen2.5-0.5B-Instruct" \
#                --log_path "./logs/bactgrow_llmsr_dec_Qwen2.5-0.5B-Instruct" \
#                > ./logs/bactgrow_llmsr_dec_Qwen2.5-0.5B-Instruct/main.txt 2>&1 
#             #    --hf_model "Qwen/Qwen2.5-0.5B-Instruct"
#             #    --log_path "./logs/oscillator1_v16"
#             #    --use_wandb True
